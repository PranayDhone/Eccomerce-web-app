...
const StorePage = () => {
  const [sortOrder, setSortOrder] = useState("lowToHigh"); // State to track sorting order
  ...
  const addToCartHandler = (item) => {
    ...
    axios
      .post(
        `https://crudcrud.com/api/337a26a7e6304929869639b1c9bb079c/cart/email/${x}`,
        postData
      )
      .then((response) => {
  ...
  const productsList = sortedProducts.map((item) => {
    return (
  ...
  return (
    <Container>
      <h1>Add your favorite Items to Store</h1>
      <Dropdown>
